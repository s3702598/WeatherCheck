# Flask application that assists in adding a city to the api
# Instructions:
# 1. Donwload file that has information on beach name and dates that it was closed
...
def upload_file():
    ...
    s3.upload_fileobj(file, 'elasticbeanstalk-us-east-1-063600141519', file.filename)
    return 'File uploaded successfully'

# function that retrieves file with water quality checks
def get_s3_data():
    try:
        obj = s3.Object('elasticbeanstalk-us-east-1-063600141519', 'TorontoBeachesData.json')
    ...
    for beach in beach_data:
        ...
        for forecast in forecast_data:
            ...
            if forecast_date in results[beach_name]:
                results[beach_name][forecast_date].append(status)
            else:
